var size = 0;
var placement = 'point';
function categories_Routessortedbycost_8(feature, value, size, resolution, labelText,
...
case 'Already Committed':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(21,72,104,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 4.028}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_Routessortedbycost_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Routessortedbycost_8(feature, value, size, resolution, labelText,
